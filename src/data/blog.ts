...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      ...
      <figure class="blog-fig-right">
        <img src="https://images.unsplash.com/photo-1586075010923-2dd45e9b2d4f?auto=format&fit=crop&w=800&q=80" alt="Figma Design Workspace" />
        <figcaption>Figure 1: Figma design canvas showing global UI token configurations.</figcaption>
      </figure>
      ...
      <figure class="blog-fig-left">
        <img src="https://images.unsplash.com/photo-1531403009284-440f080d1e12?auto=format&fit=crop&w=800&q=80" alt="Design Token Structure Sketch" />
        <figcaption>Figure 2: Figma component variant settings mapped to developer component specifications.</figcaption>
      </figure>
  ...
  },
  {
    ...
    content: `
      ...
      <figure class="blog-fig-right">
        <img src="https://images.unsplash.com/photo-1542831371-29b0f74f9713?auto=format&fit=crop&w=800&q=80" alt="Code IDE NextJS setup" />
        <figcaption>Figure 1: React Server Components (RSC) folder layout and build optimization commands.</figcaption>
      </figure>
      ...
      <figure class="blog-fig-left">
        <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80" alt="Analytics and Performance Dashboards" />
        <figcaption>Figure 2: Performance analytics dashboard showing sub-second LCP execution times.</figcaption>
      </figure>
  ...
  },
  {
    ...
    content: `
      ...
      <figure class="blog-fig-right">
        <img src="https://images.unsplash.com/photo-1571721795195-a2ca2d3370a9?auto=format&fit=crop&w=800&q=80" alt="Google Search Console Analytics" />
        <figcaption>Figure 1: Organic search query ranking dashboard showing 80% visibility growth.</figcaption>
      </figure>
  ...
  "author": {
    ...
    "name": "Sarah Jenkins"
      ...
      <figure class="blog-fig-left">
        <img src="https://images.unsplash.com/photo-1562577309-4932fdd64cd1?auto=format&fit=crop&w=800&q=80" alt="SEO schema markup validator" />
        <figcaption>Figure 2: Schema validation interface showcasing error-free metadata compilation.</figcaption>
      </figure>
  ...
  },
  {
    ...
    content: `
      ...
      <figure class="blog-fig-right">
        <img src="https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?auto=format&fit=crop&w=800&q=80" alt="Design planning with layouts" />
        <figcaption>Figure 1: UI designers wireframing user flows on standard Figma layouts.</figcaption>
      </figure>
      ...
      <figure class="blog-fig-left">
        <img src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?auto=format&fit=crop&w=800&q=80" alt="Visual UI design elements" />
        <figcaption>Figure 2: UI layout systems being crafted inside the browser interface.</figcaption>
      </figure>
  ...
  },
  {
    ...
    content: `
      ...
      <figure class="blog-fig-right">
        <img src="https://images.unsplash.com/photo-1605379399642-870262d3d051?auto=format&fit=crop&w=800&q=80" alt="Developers building applications" />
        <figcaption>Figure 1: Development screen detailing active JavaScript compilation structures.</figcaption>
      </figure>
      ...
      <figure class="blog-fig-left">
        <img src="https://images.unsplash.com/photo-1618401471353-b98aedd07871?auto=format&fit=crop&w=800&q=80" alt="Code compilation screen" />
        <figcaption>Figure 2: Render diagnostics analyzing browser paint cycles and main thread loads.</figcaption>
      </figure>
  ...
  },
  {
    ...
    content: `
      ...
      <figure class="blog-fig-right">
        <img src="https://images.unsplash.com/photo-1533750516457-a7f992034fec?auto=format&fit=crop&w=800&q=80" alt="Growth planning workspace session" />
        <figcaption>Figure 1: Strategic marketing session outlining user acquisition frameworks.</figcaption>
      </figure>
      ...
      <figure class="blog-fig-left">
        <img src="https://images.unsplash.com/photo-1542744094-3a31f103e35f?auto=format&fit=crop&w=800&q=80" alt="Digital performance statistics charts" />
        <figcaption>Figure 2: Performance marketing dashboard displaying conversion growth metrics.</figcaption>
      </figure>
